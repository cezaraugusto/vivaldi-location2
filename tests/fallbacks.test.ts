...
describe('vivaldi-location2 fallbacks', () => {
  ...
  it('macOS: strict null, fallback finds Snapshot', async () => {
  ...
  it('Windows: strict null, fallback finds Snapshot', async () => {
  ...
  it('Linux/other: strict only stable; fallback tries snapshot', async () => {
